...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    @Override
    @Transactional // For lazy initializations. If not added, might result in some errors.
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        log.debug("RecipeBootstrap_onApplicationEvent_Start...");
        recipeRepository.saveAll(getRecipes());
        log.debug("Loading Bootstrap Data   ...");
    }

    private List<Recipe> getRecipes() {
        log.debug("I'm in RecipeBootstrap...");
        ...
        //guacNotes.setRecipe(guacRecipe); // not needed now as we modified Recipe to fulfil this task.
        guacRecipe.setNotes(guacNotes);

        //very redundant could add helper method
